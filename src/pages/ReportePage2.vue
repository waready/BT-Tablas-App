<template>
  <q-page class="q-pa-md">
    ...
    >
      <q-card class="column bg-white-er" style="width: 1200px; max-width: 95vw; max-height: 95vh;">
...
const maximizedToggle = ref(true) // 👈 para el modal grande/maximizable
let editor
...
const openErModal = async () => {
  maximizedToggle.value = true // abre ya grande
